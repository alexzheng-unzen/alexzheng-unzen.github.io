...
(function () {
  ...
  function render() {
    ...
    h.push('<dialog class="demo-dialog" id="demoDialog" aria-label="' + esc(C.work.items.scheduler.demo.expand) + '"><div class="bar"><span class="cap-text"></span><button type="button" class="btn-ghost" data-act="close"></button></div><img alt="" decoding="async"></dialog>');
